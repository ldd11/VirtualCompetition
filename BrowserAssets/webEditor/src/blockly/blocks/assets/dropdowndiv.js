...
Blockly.DropDownDiv.show = function(owner, primaryX, primaryY, secondaryX, secondaryY, opt_onHide) {
  ...
  div.style.transform = 'translate(' + dx + 'px,' + dy + 'px) scale(' + Blockly.mainWorkspace.scale / Blockly.mainWorkspace.options.zoomOptions.startScale + ')';
